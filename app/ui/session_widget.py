...
class SessionWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        fields = [
            ...
            ("Bias Expired", "bias_expired"),
            ("News Lock", "news_lock"),
            ("Trades Today", "trades_today"),
            ("Daily P&L ($)", "daily_pnl"),
            ("Consec. Losses", "consecutive_losses"),
            ("Cooldown", "cooldown_until"),
            ("Break Active", "break_active"),
    ...
    def refresh(self, data: dict):
        ...
        mapping = {
            ...
            "strict_mode": "ON" if data.get("strict_mode") else "OFF",
            "bias_expired": "🛑 YES" if data.get("bias_expired") else "No",
            ...
            "break_active": "🛑 YES" if data.get("break_active") else "No",
